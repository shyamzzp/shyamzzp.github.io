...
const panelIds = ["about", "resume"] as const;
        ...
        <div className="hero-body" style={{ backgroundColor: "#f7f6ee" }}>
          <div className="container">
            <nav className="portfolio-top-nav" aria-label="Portfolio sections">
              ...
              <a href="#resume-preview">Resume Preview</a>
            </nav>
            ...
            >
              ...
              <section
                id="resume-preview"
                className="portfolio-panel portfolio-panel-resume"
              >
                <div
                  className="portfolio-panel-scroll resume-preview-scroll"
                  ref={(element) => {
                ...
                {scrollablePanels.resume ? (
                  <button
                    type="button"
                    className={`portfolio-scroll-hint ${
                      panelAtBottom.resume ? "portfolio-scroll-hint-up" : ""
                    }`}
                    aria-label={
                      panelAtBottom.resume
                        ? "Scroll resume preview to top"
                        : "Scroll resume preview down"
                    }
                    onClick={() => handleScrollIndicatorClick("resume")}
                  />
                ) : null}
              </section>
            </div>
