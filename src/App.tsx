                    ...
                    <article className="media">
                        ...
                        <div className="media-content">
                            ...
                            <nav className="level is-mobile">
                                <div className="level-left"><a aria-label="twitter" href="https://twitter.com/sud_oo"
                                        target="_blank" className="level-item" rel="noreferrer"><span className="icon is-small"><svg
                                                aria-hidden="true" className="svg-inline--fa fa-twitter fa-w-16"
                                    ...
                                    <a aria-label="githib" href="https://github.com/shyamzzp" target="_blank"
                                        className="level-item" rel="noreferrer"><span className="icon is-small"><svg aria-hidden="true"
                                                className="svg-inline--fa fa-github fa-w-16" focusable="false"
                                    ...
                                    <a aria-label="linkedin" href="https://www.linkedin.com/in/sudoo/" target="_blank"
                                        className="level-item" rel="noreferrer"><span className="icon is-small"><svg aria-hidden="true"
                                                className="svg-inline--fa fa-linkedin fa-w-14" focusable="false"
                                    ...
                                    <a aria-label="stackoverflow"
                                        href="https://stackoverflow.com/users/2256024/shyamzzp" target="_blank"
                                        className="level-item" rel="noreferrer"><span className="icon is-small"><svg aria-hidden="true"
                                                className="svg-inline--fa fa-stack-overflow fa-w-12" focusable="false"
                                                data-prefix="fab" data-icon="stack-overflow" role="img"
                                    ...
                                    <a aria-label="call" href="tel:+918591532274" target="_blank"
                                        className="level-item" rel="noreferrer"><span className="icon is-small"><svg aria-hidden="true"
                                                className="svg-inline--fa fa-phone fa-w-16" focusable="false"
                                        ...
                                        aria-label="skype" href="skype:shyamzzp@live.com?call" target="_blank"
                                        className="level-item" rel="noreferrer"><span className="icon is-small"><svg aria-hidden="true"
                                                className="svg-inline--fa fa-skype fa-w-14" focusable="false"
                                                data-prefix="fab" data-icon="skype" role="img"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                                data-fa-i2svg="">
                                                <path fill="currentColor"
                ...
                <div className="container">
                    ...
                    />
                        ...
                        >
                            <div className="section" 
                                style={{padding:'1rem 1rem 1rem', color:'rgba(52,53,65)', maxWidth:'25rem', width:'fit-content', borderRadius:'.375rem', border:'1px solid rgb(223 223 223)',}}
                                >
                                <div 
                                style={{display:'flex', alignItems:'center', justifyContent:'space-between'}}
                                >
                                    <p className="project-header-title"
                                        style={{fontSize:'1.25rem', textAlign:'start', fontWeight:'500'}}
                                        >
                                        Interview
                                        Preparation <span className="blink_me"> •
                                        </span>
                                    <div 
                                    style={{fontSize:'25px', display:'flex', marginLeft:'40px'}}
                                    >
                                ...
                                >
                                    ...
                                    • Structural approach to tackle challenges. <br />
                                ...
                                style={{marginTop:'5px'}}
                                >
                                    <span className="tag is-dark tech-stack"
                                        style={{marginTop:'5px', backgroundColor:'#3636367d'}}
                                        >ReactJS</span>
                                    <span className="tag is-dark tech-stack"
                                        style={{marginTop:'5px', backgroundColor:'#3636367d'}}>Docusaurus</span>
                                    <span className="tag is-dark tech-stack"
                                        style={{marginTop:'5px', backgroundColor:'#3636367d'}}>TypeScript</span>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        <div className="section" 
                            ...
                            <div 
                            style={{display:'flex', justifyContent:'space-between', marginTop:'8px', color:'#00000069'}}
                            >
                                <div 
